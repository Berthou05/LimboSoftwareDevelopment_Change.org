...
module.exports = class Project {
    ...
    static getEmployeeProjectIDsBtw(employee_id, start_date, end_date){
        return db.execute(`
            SELECT DISTINCT P.project_id, P.name, P.description, P.status, P.start_date, P.end_date, E.full_name AS 'lead_name'
            FROM project as P 
