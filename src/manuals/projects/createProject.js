module.exports = {
    ...
    appliesTo: ['Projects', 'Quick Start'],
    helpKey: 'quick-start.create-project',
    steps: [
        {
            ...
            image: {
                ...
                alt: 'Create Project button in the project directory',
                caption: 'Use the create action in the upper right corner of the Project page.',
            },
        },
        {
            ...
            image: {
                ...
                alt: 'New Project form with the required fields visible',
                caption: 'Name and Start Date are the only required fields.',
            },
        },
        {
            title: 'Review the form before saving',
            ...
            image: {
                ...
                alt: 'New Project form showing the cancel option',
                caption: 'Use Cancel to leave the process without creating the project.',
            },
        },
        {
            ...
            image: {
                ...
                alt: 'Projects page showing the new project in My Projects',
                caption: 'After saving, the new project appears in the My Projects section.',
            },
        },
    ],
};
