module.exports = {
    key: 'teams.managing-team-members.edit-member',
    title: 'Edit a team member role',
    summary: 'Update the role assigned to a member already participating in the team.',
    appliesTo: ['Teams', 'Employees'],
    helpKey: 'teams.managing-team-members.edit-member',
    steps: [
        {
