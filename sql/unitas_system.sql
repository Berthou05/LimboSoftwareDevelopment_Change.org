...
('col-001', 'proj-001', 'emp-001', 'Leading starter share optimization initiatives.', '2024-01-10 00:00:00', '2024-04-15 00:00:00'),
('col-002', 'proj-001', 'emp-002', 'Supporting UI improvements for share flow.', '2024-02-05 00:00:00', '2024-06-01 00:00:00'),
('col-003', 'proj-001', 'emp-019', 'Content adjustments for petition share copy.', '2024-03-12 00:00:00', '2024-07-20 00:00:00'),
('col-004', 'proj-002', 'emp-006', 'Designing A/B tests for recruit shares.', '2024-04-01 00:00:00', '2024-08-10 00:00:00'),
('col-005', 'proj-002', 'emp-018', 'Recruit funnel metrics tracking.', '2024-05-03 00:00:00', NULL),
('col-006', 'proj-003', 'emp-004', 'Improving petition validation UI.', '2024-06-15 00:00:00', '2024-10-01 00:00:00'),
('col-007', 'proj-003', 'emp-016', 'Backend validation logic updates.', '2024-07-01 00:00:00', NULL),
('col-008', 'proj-003', 'emp-003', 'Frontend optimization tasks.', '2024-08-10 00:00:00', '2024-12-01 00:00:00'),
('col-009', 'proj-004', 'emp-002', 'Notification logic redesign.', '2024-09-05 00:00:00', '2025-01-10 00:00:00'),
('col-010', 'proj-004', 'emp-020', 'Support automation enhancements.', '2024-10-01 00:00:00', NULL),
('col-011', 'proj-005', 'emp-005', 'API reliability improvements.', '2024-11-12 00:00:00', '2025-02-28 00:00:00'),
('col-012', 'proj-005', 'emp-010', 'Dashboard metrics alignment.', '2024-12-01 00:00:00', NULL),
('col-013', 'proj-006', 'emp-009', 'Mobile share performance fixes.', '2025-01-08 00:00:00', '2025-05-15 00:00:00'),
('col-014', 'proj-006', 'emp-006', 'Growth validation for mobile tests.', '2025-01-20 00:00:00', '2025-06-01 00:00:00'),
('col-015', 'proj-007', 'emp-007', 'CI/CD stability improvements.', '2025-02-10 00:00:00', '2025-06-30 00:00:00'),
('col-016', 'proj-007', 'emp-005', 'Backend deployment fixes.', '2025-03-01 00:00:00', '2025-07-10 00:00:00'),
('col-017', 'proj-008', 'emp-008', 'Security hardening implementation.', '2025-03-15 00:00:00', NULL),
('col-018', 'proj-008', 'emp-007', 'Infrastructure audit support.', '2025-04-05 00:00:00', '2025-08-20 00:00:00'),
('col-019', 'proj-009', 'emp-010', 'Dashboard query optimization.', '2025-04-18 00:00:00', '2025-09-01 00:00:00'),
('col-020', 'proj-009', 'emp-005', 'API response tuning.', '2025-05-02 00:00:00', '2025-09-15 00:00:00'),
('col-021', 'proj-010', 'emp-004', 'Design system components v2.', '2025-05-20 00:00:00', NULL),
('col-022', 'proj-010', 'emp-001', 'Integration of shared components.', '2025-06-01 00:00:00', NULL),
('col-023', 'proj-011', 'emp-011', 'CRM sync reliability updates.', '2025-06-15 00:00:00', '2025-11-01 00:00:00'),
('col-024', 'proj-011', 'emp-013', 'Internal tool adjustments.', '2025-07-01 00:00:00', NULL),
('col-025', 'proj-012', 'emp-012', 'Checkout conversion optimization.', '2025-07-20 00:00:00', '2025-12-10 00:00:00'),
('col-026', 'proj-012', 'emp-015', 'Growth experiment analysis.', '2025-08-01 00:00:00', '2025-12-20 00:00:00'),
('col-027', 'proj-013', 'emp-013', 'Admin panel feature expansion.', '2025-08-15 00:00:00', NULL),
('col-028', 'proj-013', 'emp-011', 'CRM admin tools support.', '2025-09-01 00:00:00', NULL),
('col-029', 'proj-014', 'emp-014', 'Community ranking improvements.', '2025-09-20 00:00:00', NULL),
('col-030', 'proj-014', 'emp-019', 'Content structure optimization.', '2025-10-05 00:00:00', NULL),
('col-031', 'proj-015', 'emp-015', 'Growth experimentation strategy.', '2025-10-20 00:00:00', NULL),
('col-032', 'proj-015', 'emp-006', 'A/B test technical setup.', '2025-11-01 00:00:00', NULL),
('col-033', 'proj-016', 'emp-016', 'Validation engine rebuild.', '2025-11-15 00:00:00', NULL),
('col-034', 'proj-016', 'emp-004', 'UI validation messaging updates.', '2025-12-01 00:00:00', NULL),
('col-035', 'proj-017', 'emp-017', 'AI classification development.', '2025-12-10 00:00:00', NULL),
('col-036', 'proj-017', 'emp-001', 'Integration of AI responses.', '2025-12-20 00:00:00', NULL),
('col-037', 'proj-018', 'emp-018', 'Recruit funnel metrics design.', '2026-01-05 00:00:00', NULL),
('col-038', 'proj-018', 'emp-006', 'Growth experimentation link.', '2026-01-10 00:00:00', NULL),
('col-039', 'proj-019', 'emp-019', 'Petition content optimization.', '2026-01-15 00:00:00', NULL),
('col-040', 'proj-019', 'emp-010', 'Analytics alignment.', '2026-01-18 00:00:00', NULL),
('col-041', 'proj-000', 'emp-005', 'General maintenance tasks.', '2026-01-20 00:00:00', NULL),
('col-042', 'proj-000', 'emp-020', 'Support automation improvements.', '2026-01-22 00:00:00', NULL),
('col-043', 'proj-000', 'emp-003', 'Unassigned operational tasks.', '2026-01-25 00:00:00', NULL),
('col-044', 'proj-001', 'emp-006', 'Growth validation for shares.', '2026-02-01 00:00:00', NULL),
('col-045', 'proj-004', 'emp-014', 'Community engagement alignment.', '2026-02-05 00:00:00', NULL),
('col-046', 'proj-010', 'emp-008', 'Security review of components.', '2026-02-10 00:00:00', NULL),
('col-047', 'proj-003', 'emp-010', 'Analytics support for validation.', '2026-02-12 00:00:00', NULL),
('col-048', 'proj-015', 'emp-002', 'Experiment support on UX copy.', '2026-02-15 00:00:00', NULL),
('col-049', 'proj-018', 'emp-017', 'AI analytics cross-support.', '2026-02-20 00:00:00', NULL),
('col-050', 'proj-019', 'emp-001', 'Frontend content rendering updates.', '2026-02-25 00:00:00', NULL);
-- --------------------------------------------------------
