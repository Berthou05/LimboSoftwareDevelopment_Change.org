...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2026 at 03:50 AM
...
('act-001', 'proj-001', 'emp-003', 'de-001', 'Share Component Refactor', 'Refactored share button logic and tracking fixes', '2026-02-01'),
('act-002', 'proj-001', 'emp-003', 'de-002', 'Endorsement Form Update', 'Updated endorsement form and validation schema', '2026-02-02'),
('act-003', 'proj-003', 'emp-004', 'de-003', 'Petition Quality Pipeline', 'Improved validation and scoring logic', '2026-02-01'),
('act-004', 'proj-000', 'emp-005', 'de-004', 'General Refactor Work', 'Miscellaneous improvements and cleanup', '2026-02-01'),
('act-005', 'proj-002', 'emp-006', 'de-005', 'Recruit Share Experiment', 'Implemented A/B test adjustments', '2026-02-03'),
('act-006', 'proj-001', 'emp-001', 'de-006', 'Share Modal Optimization', 'Performance improvements in share modal', '2026-02-03'),
('act-007', 'proj-002', 'emp-002', 'de-007', 'Supporter Dashboard Improvements', 'Optimized dashboard and notifications', '2026-02-04'),
('act-008', 'proj-000', 'emp-007', 'de-008', 'Pipeline Cleanup', 'CI and feature flag cleanup', '2026-02-04'),
('act-009', 'proj-004', 'emp-002', 'de-009', 'Notification Optimization', 'Improved supporter notification batching', '2026-02-05'),
('act-010', 'proj-005', 'emp-005', 'de-010', 'Tracking Audit', 'Cleaned legacy analytics events', '2026-02-05'),
('act-011', 'proj-006', 'emp-006', 'de-011', 'Mobile Share Improvements', 'Optimized mobile share performance', '2026-02-06'),
('act-012', 'proj-007', 'emp-007', 'de-012', 'CI Pipeline Stabilization', 'Improved CI reliability', '2026-02-06'),
('act-013', 'proj-008', 'emp-008', 'de-013', 'Security Hardening', 'Patched dependencies and improved CSP', '2026-02-07'),
('act-014', 'proj-009', 'emp-009', 'de-014', 'Dashboard Query Optimization', 'Reduced dashboard load time', '2026-02-07'),
('act-015', 'proj-010', 'emp-010', 'de-015', 'Design System Migration', 'Migrated to new design tokens', '2026-02-08'),
('act-016', 'proj-011', 'emp-011', 'de-016', 'CRM Sync Refactor', 'Improved CRM sync reliability', '2026-02-08'),
('act-017', 'proj-012', 'emp-012', 'de-017', 'Checkout Optimization', 'Improved checkout conversion', '2026-02-09'),
('act-018', 'proj-013', 'emp-013', 'de-018', 'Admin Panel Improvements', 'Enhanced internal admin tools', '2026-02-09'),
('act-019', 'proj-014', 'emp-014', 'de-019', 'Feed Ranking Tuning', 'Improved community ranking algorithm', '2026-02-10'),
('act-020', 'proj-000', 'emp-015', 'de-020', 'General Cleanup Work', 'Non project specific improvements', '2026-02-10');
...
('priv-001', 'VIEW_REPORT', 'Can view reports'),
('priv-002', 'GENERATE_REPORT', 'Can generate reports'),
('priv-003', 'MANAGE_USERS', 'Can manage users'),
('priv-004', 'MANAGE_ROLES', 'Can manage roles'),
('priv-005', 'MANAGE_PRIVILEGES', 'Can manage privileges'),
('priv-006', 'CREATE_GOAL', 'Can create goals'),
('priv-007', 'EDIT_GOAL', 'Can edit goals'),
('priv-008', 'CREATE_PROJECT', 'Can create projects'),
('priv-009', 'EDIT_PROJECT', 'Can edit projects'),
('priv-010', 'VIEW_ANALYTICS', 'Can view analytics dashboard');
...
INSERT INTO `team` (`team_id`, `employee_responsible_id`, `name`, `description`, `created_at`, `image`) VALUES
('team-001', 'emp-001', 'Axolotl Squad', 'Starter Experience and onboarding flows', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/axolotl-squad.png'),
('team-002', 'emp-002', 'Vaquita Squad', 'Supporter Experience and engagement tools', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/vaquita-squad.png'),
('team-003', 'emp-003', 'Jaguar Squad', 'Frontend architecture and performance', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/jaguar-squad.png'),
('team-004', 'emp-004', 'Colibrí Squad', 'Design system and UI consistency', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/colibri-squad.png'),
('team-005', 'emp-005', 'Tortuga Squad', 'Backend APIs and stability', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/tortuga-squad.png'),
('team-006', 'emp-006', 'Águila Squad', 'Growth experiments and A/B testing', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/aguila-squad.png'),
('team-007', 'emp-007', 'Lobo Squad', 'Platform and DevOps', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/lobo-squad.png'),
('team-008', 'emp-008', 'Pantera Squad', 'Security and compliance', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/pantera-squad.png'),
('team-009', 'emp-009', 'Delfín Squad', 'Mobile features', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/delfin-squad.png'),
('team-010', 'emp-010', 'Búho Squad', 'Analytics and dashboards', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/buho-squad.png'),
('team-011', 'emp-011', 'Ocelote Squad', 'CRM integrations', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/ocelote-squad.png'),
('team-012', 'emp-012', 'Halcón Squad', 'Payments and checkout flows', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/halcon-squad.png'),
('team-013', 'emp-013', 'Coyote Squad', 'Internal tools', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/coyote-squad.png'),
('team-014', 'emp-014', 'Mariposa Squad', 'Community features', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/mariposa-squad.png'),
('team-015', 'emp-015', 'Tiburón Squad', 'High impact experiments', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/tiburon-squad.png'),
('team-016', 'emp-016', 'Armadillo Squad', 'Petition validation engine', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/armadillo-squad.png'),
('team-017', 'emp-017', 'Mapache Squad', 'AI innovation', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/mapache-squad.png'),
('team-018', 'emp-018', 'Venado Squad', 'Recruitment tech', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/venado-squad.png'),
('team-019', 'emp-019', 'Camaleón Squad', 'Content optimization', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/camaleon-squad.png'),
('team-020', 'emp-020', 'Hormiga Squad', 'Support tooling and automation', '2026-01-01 00:00:00', 'https://cdn.unitas-platform.com/teams/hormiga-squad.png');
