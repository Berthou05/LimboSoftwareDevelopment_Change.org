...
('act-061', 'proj-001', 'emp-001', 'de-041', 'Share Modal Refactor', 'Refactored modal rendering logic', '2026-03-21'),
('act-062', 'proj-001', 'emp-001', 'de-041', 'Bundle Size Reduction', 'Reduced bundle size for performance', '2026-03-21'),
('act-063', 'proj-005', 'emp-001', 'de-041', 'Tracking Delay Fix', 'Fixed delayed analytics tracking events', '2026-03-21'),
('act-064', 'proj-001', 'emp-001', 'de-041', 'Unit Test Coverage', 'Added unit tests for modal logic', '2026-03-21'),
('act-065', 'proj-007', 'emp-001', 'de-041', 'Code Reviews', 'Reviewed multiple pull requests', '2026-03-21'),
-- de-042 (emp-001 | 2026-03-24)
('act-066', 'proj-002', 'emp-001', 'de-042', 'API Optimization', 'Reduced redundant API calls', '2026-03-24'),
('act-067', 'proj-002', 'emp-001', 'de-042', 'Caching Implementation', 'Implemented caching layer', '2026-03-24'),
('act-068', 'proj-002', 'emp-001', 'de-042', 'Edge Case Fixes', 'Resolved edge case issues in share flow', '2026-03-24'),
('act-069', 'proj-009', 'emp-001', 'de-042', 'Logging Improvements', 'Added detailed logging', '2026-03-24'),
('act-070', 'proj-002', 'emp-001', 'de-042', 'Flow Testing', 'Tested flows in staging environment', '2026-03-24'),
-- de-043 (emp-002 | 2026-03-22)
('act-071', 'proj-002', 'emp-002', 'de-043', 'Dashboard UI Update', 'Improved dashboard layout and UX', '2026-03-22'),
('act-072', 'proj-004', 'emp-002', 'de-043', 'Notification Bug Fix', 'Fixed duplicate notification issue', '2026-03-22'),
('act-073', 'proj-002', 'emp-002', 'de-043', 'Loader Implementation', 'Added skeleton loaders for UI', '2026-03-22'),
('act-074', 'proj-002', 'emp-002', 'de-043', 'Component Refactor', 'Refactored dashboard components', '2026-03-22'),
('act-075', 'proj-007', 'emp-002', 'de-043', 'PR Reviews', 'Reviewed team pull requests', '2026-03-22'),
-- de-044 (emp-002 | 2026-03-26)
('act-076', 'proj-004', 'emp-002', 'de-044', 'Notification Optimization', 'Improved batching performance', '2026-03-26'),
('act-077', 'proj-004', 'emp-002', 'de-044', 'Monitoring Integration', 'Added monitoring logs', '2026-03-26'),
('act-078', 'proj-004', 'emp-002', 'de-044', 'Retry Logic Fix', 'Fixed retry handling bug', '2026-03-26'),
('act-079', 'proj-004', 'emp-002', 'de-044', 'Edge Case Testing', 'Tested delayed notification scenarios', '2026-03-26'),
('act-080', 'proj-004', 'emp-002', 'de-044', 'Config Updates', 'Updated notification configs', '2026-03-26'),
-- de-045 (emp-003 | 2026-03-23)
('act-081', 'proj-001', 'emp-003', 'de-045', 'Endorsement Flow Refactor', 'Refactored endorsement flow logic', '2026-03-23'),
('act-082', 'proj-003', 'emp-003', 'de-045', 'Validation Improvement', 'Enhanced validation schema', '2026-03-23'),
('act-083', 'proj-001', 'emp-003', 'de-045', 'UI Fixes', 'Resolved UI alignment issues', '2026-03-23'),
('act-084', 'proj-001', 'emp-003', 'de-045', 'Test Coverage', 'Added unit tests for endorsement flow', '2026-03-23'),
('act-085', 'proj-010', 'emp-003', 'de-045', 'Design Sync', 'Aligned implementation with design team', '2026-03-23'),
-- de-046 (emp-003 | 2026-03-27)
('act-086', 'proj-005', 'emp-003', 'de-046', 'Analytics Event Fixes', 'Resolved missing analytics events', '2026-03-27'),
('act-087', 'proj-005', 'emp-003', 'de-046', 'Tracking Accuracy Improvement', 'Improved tracking consistency', '2026-03-27'),
('act-088', 'proj-001', 'emp-003', 'de-046', 'Performance Optimization', 'Optimized frontend performance', '2026-03-27'),
('act-089', 'proj-009', 'emp-003', 'de-046', 'Logging Enhancements', 'Added structured logging', '2026-03-27'),
('act-090', 'proj-007', 'emp-003', 'de-046', 'Code Review', 'Reviewed PRs and suggested improvements', '2026-03-27'),
-- de-047
('act-091', 'proj-001', 'emp-001', 'de-047', 'UX Improvement', 'Improved share UX transitions', '2026-03-22'),
('act-092', 'proj-001', 'emp-001', 'de-047', 'Edge Case Fixes', 'Resolved UX edge cases', '2026-03-22'),
('act-093', 'proj-009', 'emp-001', 'de-047', 'Logging Implementation', 'Added structured logs', '2026-03-22'),
('act-094', 'proj-006', 'emp-001', 'de-047', 'Mobile Testing', 'Tested mobile responsiveness', '2026-03-22'),
('act-095', 'proj-007', 'emp-001', 'de-047', 'PR Reviews', 'Reviewed pull requests', '2026-03-22'),
-- de-048
('act-096', 'proj-002', 'emp-002', 'de-048', 'Dashboard Refactor', 'Refactored dashboard structure', '2026-03-23'),
('act-097', 'proj-009', 'emp-002', 'de-048', 'Query Optimization', 'Optimized backend queries', '2026-03-23'),
('act-098', 'proj-002', 'emp-002', 'de-048', 'Loader Implementation', 'Added loading states', '2026-03-23'),
('act-099', 'proj-002', 'emp-002', 'de-048', 'UI Bug Fixes', 'Resolved UI inconsistencies', '2026-03-23'),
('act-100', 'proj-007', 'emp-002', 'de-048', 'Team Sync', 'Aligned with team on changes', '2026-03-23'),
-- de-049
('act-101', 'proj-003', 'emp-003', 'de-049', 'Validation Improvements', 'Enhanced validation logic', '2026-03-24'),
('act-102', 'proj-003', 'emp-003', 'de-049', 'Bug Fixes', 'Resolved validation bugs', '2026-03-24'),
('act-103', 'proj-001', 'emp-003', 'de-049', 'Test Coverage', 'Added unit tests', '2026-03-24'),
('act-104', 'proj-001', 'emp-003', 'de-049', 'Flow Optimization', 'Optimized frontend flow', '2026-03-24'),
('act-105', 'proj-000', 'emp-003', 'de-049', 'Code Cleanup', 'Cleaned legacy code', '2026-03-24'),
-- de-050
('act-106', 'proj-001', 'emp-001', 'de-050', 'Rendering Optimization', 'Reduced unnecessary re-renders', '2026-03-25'),
('act-107', 'proj-002', 'emp-001', 'de-050', 'Caching Improvement', 'Improved caching layer', '2026-03-25'),
('act-108', 'proj-009', 'emp-001', 'de-050', 'Logging Update', 'Enhanced logging system', '2026-03-25'),
('act-109', 'proj-002', 'emp-001', 'de-050', 'Flow Testing', 'Validated application flows', '2026-03-25'),
('act-110', 'proj-001', 'emp-001', 'de-050', 'Bug Fix', 'Fixed rendering bug', '2026-03-25'),
-- de-051
('act-111', 'proj-004', 'emp-002', 'de-051', 'Notification Fix', 'Resolved duplication issue', '2026-03-21'),
('act-112', 'proj-004', 'emp-002', 'de-051', 'Monitoring Logs', 'Added monitoring system', '2026-03-21'),
('act-113', 'proj-004', 'emp-002', 'de-051', 'Retry Testing', 'Tested retry scenarios', '2026-03-21'),
('act-114', 'proj-004', 'emp-002', 'de-051', 'Config Updates', 'Updated system configs', '2026-03-21'),
('act-115', 'proj-009', 'emp-002', 'de-051', 'Logging Improvements', 'Improved logging visibility', '2026-03-21'),
-- de-052
('act-116', 'proj-001', 'emp-003', 'de-052', 'Share Flow Refactor', 'Refactored share flow', '2026-03-22'),
('act-117', 'proj-005', 'emp-003', 'de-052', 'Analytics Improvement', 'Improved tracking events', '2026-03-22'),
('act-118', 'proj-001', 'emp-003', 'de-052', 'UI Fixes', 'Resolved UI issues', '2026-03-22'),
('act-119', 'proj-001', 'emp-003', 'de-052', 'Test Implementation', 'Added tests', '2026-03-22'),
('act-120', 'proj-007', 'emp-003', 'de-052', 'Code Reviews', 'Reviewed pull requests', '2026-03-22'),
-- de-053
('act-121', 'proj-002', 'emp-001', 'de-053', 'API Optimization', 'Improved API performance', '2026-03-26'),
('act-122', 'proj-009', 'emp-001', 'de-053', 'DB Optimization', 'Optimized database queries', '2026-03-26'),
('act-123', 'proj-002', 'emp-001', 'de-053', 'Caching Layer', 'Implemented caching', '2026-03-26'),
('act-124', 'proj-002', 'emp-001', 'de-053', 'Endpoint Testing', 'Tested endpoints', '2026-03-26'),
('act-125', 'proj-001', 'emp-001', 'de-053', 'Bug Fixes', 'Resolved API bugs', '2026-03-26'),
-- de-054
('act-126', 'proj-002', 'emp-002', 'de-054', 'Filter Enhancement', 'Improved dashboard filters', '2026-03-27'),
('act-127', 'proj-002', 'emp-002', 'de-054', 'UI Fix', 'Resolved UI issues', '2026-03-27'),
('act-128', 'proj-002', 'emp-002', 'de-054', 'UX Improvements', 'Enhanced user experience', '2026-03-27'),
('act-129', 'proj-002', 'emp-002', 'de-054', 'Test Coverage', 'Added tests', '2026-03-27'),
('act-130', 'proj-000', 'emp-002', 'de-054', 'Code Cleanup', 'Removed unused code', '2026-03-27'),
-- de-055
('act-131', 'proj-001', 'emp-003', 'de-055', 'Endorsement Flow Update', 'Improved endorsement logic', '2026-03-25'),
('act-132', 'proj-003', 'emp-003', 'de-055', 'Validation Fix', 'Fixed validation issues', '2026-03-25'),
('act-133', 'proj-009', 'emp-003', 'de-055', 'Logging', 'Added logs', '2026-03-25'),
('act-134', 'proj-001', 'emp-003', 'de-055', 'UI Optimization', 'Improved UI performance', '2026-03-25'),
('act-135', 'proj-001', 'emp-003', 'de-055', 'Flow Testing', 'Tested flows', '2026-03-25'),
-- de-056
('act-136', 'proj-000', 'emp-001', 'de-056', 'Codebase Cleanup', 'Cleaned overall codebase', '2026-03-27'),
('act-137', 'proj-007', 'emp-001', 'de-056', 'PR Reviews', 'Reviewed pull requests', '2026-03-27'),
('act-138', 'proj-009', 'emp-001', 'de-056', 'Logging Improvements', 'Improved logging system', '2026-03-27'),
('act-139', 'proj-002', 'emp-001', 'de-056', 'Deployment Fixes', 'Deployed fixes to production', '2026-03-27'),
('act-140', 'proj-002', 'emp-001', 'de-056', 'Flow Verification', 'Verified system flows post-deploy', '2026-03-27');
